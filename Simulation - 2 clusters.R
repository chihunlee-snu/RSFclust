...
### Run K-expectile clustering separately, since the source code of K-expectile clustering is written in Python
...
a = final2(1, 1, simulnum = 2, sig = 0.1) # 18 seconds per simulation
