...
simulation3 <- function(num, sc, param = c(10, 0.5, 0, 0, 2.5, TRUE), curvenum = 50, simulnum = 50, pdiff = 0.5, sig = 0.2){
  csr1 = rep(0, simulnum)
  ari1 = rep(0, simulnum)
  maf1 = rep(0, simulnum)
  csr2 = rep(0, simulnum)
  ...
  for(i in 1:simulnum){
    ...
    RSFclust1 = RSKC(qsparse, 3, alpha = 0.1, L1 = 3)
    RSFclust2 = RSKC.multidim(qsparse, ncl = 3, l1bound = 3)
    
    print("RSFclust1 weight")
    print(RSFclust1$weights)
...
a = simulation3(1, 1, simulnum = 2, sig = 0.1) # 27 seconds per simulation
...
score1 = matrix(nrow = 9, ncol = 36)

for(i in 1:3){
  for(j in 1:3){
    a = simulation3(1, i, simulnum = 50, sig = 0.1*j)
...
write.csv(score1, file = "score1.csv")


### Example 2

score2 = matrix(nrow = 9, ncol = 36)

for(i in 1:3){
  for(j in 1:3){
    a = simulation3(2, i, simulnum = 50, sig = 0.1*j)
...
setwd("C://Users//user//Desktop//4학년 2학기//인턴//Code//simulation table")
write.csv(score2, file = "score2.csv")


### Example 3

score3 = matrix(nrow = 9, ncol = 36)

for(i in 1:3){
  for(j in 1:3){
    a = simulation3(3, i, simulnum = 50, sig = 0.1*j)
...
setwd("C://Users//user//Desktop//4학년 2학기//인턴//Code//simulation table")
write.csv(score3, file = "score3.csv")
